...
left outer join patient_latest_identifier as dstb on dstb.implementation_id = p.implementation_id and dstb.patient_id = p.patient_id and dstb.identifier_type = 7 
